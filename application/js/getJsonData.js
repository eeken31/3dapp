...
$(document).ready(function(){
    ...
    $.getJSON('../application/model/data.json', function(jsonObj) {
       ...
       //Get the coca cola gallery contents data
       $('.title_coca_cola_gallery').html('<h2>' + jsonObj.pageTextData[7].galleryTitle + '<h2>');
       $('.coca_cola_description_gallery').html('<p>' + jsonObj.pageTextData[7].galleryDescription + '</p>');

       //Get the sprite gallery contents data
       $('.title_sprite_gallery').html('<h2>' + jsonObj.pageTextData[8].galleryTitle + '<h2>');
       $('.sprite_description_gallery').html('<p>' + jsonObj.pageTextData[8].galleryDescription + '</p>');

       //Get the dr pepper gallery contents data
       $('.title_dr_pepper_gallery').html('<h2>' + jsonObj.pageTextData[9].galleryTitle + '<h2>');
       $('.dr_pepper_description_gallery').html('<p>' + jsonObj.pageTextData[9].galleryDescription + '</p>');
