            ...
            <div class="row">
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="../application/assets/images/render_images/coca_cola/2.png" data-fancybox data-caption="My 3D Coke Can Render">
                  ...
                  <div class="col-sm-4">
                      <div class="card">
                          <a href="../application/assets/images/render_images/sprite/6.png" data-fancybox data-caption="My 3D Sprite Bottle Render" class="img-narrow">
                  ...
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="../application/assets/images/render_images/dr_pepper/11.png" data-fancybox data-caption="My 3D Dr Pepper Bottle Render" class="thumbnail">
                ...
                <div class="card text-left">
                  ...
                  <div class="card-body">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-success btn-responsive" onMouseUP="pepperScene(); pepperDescription();">Dr Pepper</button>
                          ...
                          <x3d id="model">
                            <scene>
                                <Switch whichChoice="0" id='SceneSwitch'>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../application/assets/x3d/coca_cola.x3d" > </inline>
                                    </transform>
                                    <transform>
                ...
                <div class="col-sm-4">
                    <div class="card text-left">
                        ...
                        <div class="card-body">
                          ...
                          <a href="#" class="btn btn-outline-dark btn-responsive">RotY</a>
                          <a href="#" class="btn btn-outline-dark btn-responsive">RotZ</a>
              ...
              <div class="col-sm-12">
                  <div class="card">
                      <div class="card-body">
                        ...
                        <a href="http://www.coca-cola.co.uk/drinks/dr-pepper/dr-pepper" class="btn btn-primary btn-responisve">Visit Dr Pepper.</a>                 
                      </div>
                  </div>
              </div>
      ...
      <nav id="footerColor" class="navbar navbar-expand-sm footer">
          <div class="container-fluid">   
              ...
              <div class="navbar-text float-right">
                  <p><span class="align-baseline">Change theme: <a href="javascript:light()">Light</a> | <a href="javascript:dark()">Dark</a></span></p>
              </div>
          </div>
      </nav> 
      <!-- My 3D App modals -->
